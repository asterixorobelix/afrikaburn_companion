...
- [Path Conventions (Existing Codebase)](#path-conventions-existing-codebase)
- [Phase 3.1: Setup and Dependencies](#phase-31-setup-and-dependencies)
- [Phase 3.2: Database and Data Models (TDD) ⚠️ MUST COMPLETE BEFORE 3.3](#phase-32-database-and-data-models-tdd-must-complete-before-33)
  - [Contract Tests for Backend API](#contract-tests-for-backend-api)
  - [Integration Tests for Mobile Features](#integration-tests-for-mobile-features)
- [Phase 3.3: Core Data Models (ONLY after tests are failing)](#phase-33-core-data-models-only-after-tests-are-failing)
  - [Database Schema and Models](#database-schema-and-models)
- [Phase 3.4: Repository Layer and Data Access](#phase-34-repository-layer-and-data-access)
  - [Repository Interfaces](#repository-interfaces)
  - [Repository Implementations](#repository-implementations)
- [Phase 3.5: Use Cases and Business Logic](#phase-35-use-cases-and-business-logic)
  - [Core Use Cases](#core-use-cases)
- [Phase 3.6: Backend API Implementation](#phase-36-backend-api-implementation)
  - [Event Management Endpoints](#event-management-endpoints)
  - [Smart Sync Endpoints](#smart-sync-endpoints)
  - [Safety and Emergency Endpoints](#safety-and-emergency-endpoints)
- [Phase 3.7: Mobile UI - Update Existing Screens](#phase-37-mobile-ui---update-existing-screens)
  - [Update Navigation and Theme](#update-navigation-and-theme)
  - [Update Existing Screens](#update-existing-screens)
  - [New Core Screens](#new-core-screens)
- [Phase 3.8: ViewModels and Presentation Layer](#phase-38-viewmodels-and-presentation-layer)
  - [Update Existing ViewModels](#update-existing-viewmodels)
  - [New ViewModels](#new-viewmodels)
  - [Community and Social ViewModels](#community-and-social-viewmodels)
- [Phase 3.9: Platform-Specific Implementations](#phase-39-platform-specific-implementations)
  - [GPS and Location Services](#gps-and-location-services)
  - [File Storage and Caching](#file-storage-and-caching)
- [Phase 3.10: Dependency Injection Updates](#phase-310-dependency-injection-updates)
  - [Update Existing DI Modules](#update-existing-di-modules)
- [Phase 3.11: Integration and Middleware](#phase-311-integration-and-middleware)
  - [Smart Sync Engine](#smart-sync-engine)
  - [Offline Storage Management](#offline-storage-management)
  - [Backend Services and Business Logic](#backend-services-and-business-logic)
  - [Community Features Implementation](#community-features-implementation)
- [Phase 3.12: Polish and Performance](#phase-312-polish-and-performance)
...
- [Dependencies](#dependencies)
  ...
  - [Critical Blocking Dependencies](#critical-blocking-dependencies)
- [Parallel Execution Examples](#parallel-execution-examples)
  - [Setup Phase (can run simultaneously)](#setup-phase-can-run-simultaneously)
  - [Contract Tests Phase (all parallel - different files)](#contract-tests-phase-all-parallel---different-files)
  - [Data Models Phase (all parallel - different files)](#data-models-phase-all-parallel---different-files)
- [Notes](#notes)
